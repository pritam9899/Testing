...
function displayData(courseData) {
    ...
    dataforCards.forEach(course => {
        ...
        thumbnail.src = "data:image/png;base64,data:image/png;base64,https://i0.wp.com/www.powerbi-influential.com/wp-content/uploads/2022/05/power-bi-april-features.png?res";
